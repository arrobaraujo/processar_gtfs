...
fwrite(partidas_adj, paste0("C:/R_SMTR/dados/os/os_porhora_", ano_gtfs, "-", mes_gtfs, "-", quinzena_gtfs, "_sent.csv"),sep=';',dec=',')
...
# Salvar o arquivo
saveWorkbook(wb, paste0("C:/R_SMTR/dados/os/partidas_", ano_gtfs, "-", mes_gtfs, "-", quinzena_gtfs, "_pf.xlsx"), overwrite = TRUE)
